...
<body>
    ...
    <nav>
        <div class="dropdown">
            <p class="icon-right-hand" id="dropButton">&nbsp; Media</p>
            <div class="tabs">
                <a href="/">Start</a>
    ...
    <main>
        ...
        <article id="press">
            ...
            <section class="buttons" id="events">
                ...
                <i class="icon-down"></i>
                <a href="docs/odpTK_06-06-2019.pdf" target="_blank" class="button">Tekst: odpowiedź Trans Kontrol do ZTM Poznań, 6 czerwca 2019 r.</a>
                <i class="icon-down"></i>
                <a href="docs/tenpoznan.pl_08-06-2019.pdf" target="_blank" class="button">Tekst: anonimowy autor o inicjałach "el" Radio Poznań, redakcja Tenpoznan.pl, 8 czerwca 2019 r.</a>
                <i class="icon-down"></i>
                <a href="docs/komentarz_prosba_08.06.2019.pdf" target="_blank" class="button">Mój komentarz i prośba do rodziców, 8 czerwca 2019 r.</a>
                <i class="icon-down"></i>
                <a href="docs/komentarz_wlasny_08-06-2019.pdf" target="_blank" class="button">Mój komentarz do poziomu dziennikarskich artykułów, 8 czerwca 2019 r.</a>
            </section>
            <section>
            ...
            <section class="buttons" id="events">
                ...
                <i class="icon-down"></i>
                <a href="docs/oswiadczenie_swiadka.pdf" target="_blank" class="button">Oświadczenie świadka zdarzenia</a>
                <i class="icon-down"></i>
                <a href="docs/skarga_oryginal_05-06-2019.pdf" target="_blank" class="button">Skarga z dnia 05-06-2019 (w oryginale)</a>
                <i class="icon-down"></i>
                <a href="docs/analiza_sieci_spolecznosciowej.pdf" target="_blank" class="button">Analiza sieci społecznościowej wraz z oceną postępowania mediów (Głos Wlkp., Radio Poznań, Rokietnica Wokół Nas, Rokietnica24, TenPoznan)</a>
            </section>
            <section>
                <b>Uwagi</b>
                <p>Dane osobowe osoby skarżącej zastrzeżone. Osoba ta zezwoliła na ujawnienie tylko imienia i nazwiska w przestrzeni publicznej. Dane z portali internetowych (Facebook) są powszechnie dostępne i mają charakter publiczny. Osoby umieszczające tam swoje zdjęcia, komentarze i dane osobowe wyrażają na to zgodę (na publiczne udostępnienie). Dane osobowe świadka zdarzenia tj. kobiety jadącej autobusem w dniu zdarzenia) do wiadomości jedynie Prezesa ZUK Rokbus oraz Trans Kontrol. Osoba nie wyraziła zgody na upublicznienie tych danych. Wyrażono zgodę jedynie na publikację treści złożonego oświadczenia.</p>
