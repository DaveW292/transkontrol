...
<body>
    ...
    <main>
        <article>
            <h4>WARNING! When submitting an appeal, it is mandatory to provide the current address of residence as well as the correspondence address and PESEL number of the punished person in order to properly verify the passenger</h4>
            <h3>APPEALS ON CREDIT ADDITIONAL CHARGES (CAC)</h3>
            <ol>
        ...
        <article>
            <h3>CHARGES</h3>
            <table class="charges">
                <tr><th colspan="2">TABLE OF CHARGES</th></tr>
                <tr>
                    <th>The fee (and its nature)</th>
                    <th>Description</th>
                </tr>
                <tr>
                    <td>Handling fee (statutory)</td>
                    <td>The amount of the fee is determined by the given Carrier</td>
                </tr>
                <tr>
                    <td>Installment service costs (contractual)</td>
                    <td>30% of the debt value</td>
                </tr>
                <tr>
                    <td>Request for payment costs (resolution or the like)</td>
                    <td>These are the costs specified in order regulations or the Transport Regulations of a given carrier or in other legal acts established by the authorized local authorities</td>
                </tr>
                <tr>
                    <td>
                        Fee for a complaint against ODG (conditionally returnable)
                        <br/><i>Applies only to CASH PAYMENT - paid on the spot at the controller (see complaints)</i>
                    </td>
                    <td>PLN 20 paid in advance, returnable in the event of violation of the law by the controller)</td>
                </tr>
                <tr>
            ...
            <table class="charges">
                ...
                <tr>
                    ...
                    <td>After 60 days from the date of the event (the date the additional fee is charged) or at a later date</td>
                </tr>
                <tr>
                    <td>Transfer of the case to court (lawsuit)</td>
                    <td>After 180 days from the date of the event (the date the additional fee is charged) or at a later date</td>
                </tr>
                <tr>
                    <td>Transfer of the bailiff's enforcement case</td>
