...
<head>
    ...
    <title>Trans Kontrol - services</title>
...
<body>
    ...
    <nav>
        <div class="dropdown">
            <p class="icon-right-hand" id="dropButton">&nbsp; Services</p>
            <div class="tabs">
                <a href="home">Home</a>
                <a href="about-us">About Us</a>
                <a id="activeTab">Services</a>
    ...
    <main>
        <article>
            ...
            <div class="li"><i class="icon-train"></i><p>Survey of passenger satisfaction with the services provided</p></div>
        </article>
        <h2>COOPERATION OFFERS</h2>
        <article>
            <h3>Ticket control</h3>
            <div class="li"><i class="icon-right-outline"></i><p>We conduct complete and supplementary inspections, work inspections:</p></div>
                <div class="subLi"><i class="icon-right-circled"></i><p>Complete inspections - we take full control over the Carrier's lines in terms of ticket inspection</p></div>
            ...
            <div class="li"><i class="icon-right-outline"></i><p>We adjust our own procedures to the Carrier's existing procedures:</p></div>
                ...
                <div class="subLi"><i class="icon-right-circled"></i><p>Constant supervision over work</p></div>
                <div class="subLi"><i class="icon-right-circled"></i><p>Quick implementation of new work procedures to improve the quality of work</p></div>
        ...
        <article>
            <h3>Control of drivers' work</h3>
            <ol>
                <li>Special action</li>
                <li>Special car action</li>
                <li>Regular car action</li>
                <li>Discreet control (observation)</li>
                <li>Discreet control using technical means (observation and registration)</li>
                <li>Timetable and rolling stock control</li>
                <li>Ordinary checks</li>
                <li>Dedicated controls</li>
            </ol>
